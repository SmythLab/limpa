...
We are aware that DIA-NN no longer exports its main report in the `.tsv` format, but in the `.parquet` instead from version 2.0. 
To read in the `.parquet ` output, use
